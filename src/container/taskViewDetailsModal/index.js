...
import styles from "./taskViewDetailsModal.module.css";
...
const TaskViewDetailsModal = ({
  ...
  useEffect(() => {
    if (CommentsData !== null) {
      ...
      if (task.PK_TID === CommentsData.fK_TID) {
              ...
              <Col sm={12} md={12} lg={12} className="mb-2">
                ...
                >
                  ...
                  <Col
                    ...
                    md={1}
                    lg={1}
                    className="comment-enter-button d-flex justify-content-center align-items-center"
                  >
                    {currentLanguage === "ar" ? (
                      <ChevronLeft
                        width={25}
...
export default TaskViewDetailsModal;
