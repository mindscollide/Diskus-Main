        ...
        <Container>
            <Row>
                <Col sm={12} md={6} lg={6} className="py-3">
                    ...
                    <Row>
                        <Col sm={12} md={6} lg={6}>Old Password</Col>
                    ...
                    <Row className='my-4'>
                        <Col sm={12} md={6} lg={6}>New  Password</Col>
                        <Col sm={12} md={6} lg={6} className="position-relative">        <TextField
                            applyClass="form-control2"
                            className="PasswordTextField"
                    ...
                    <Row className='my-2'>
                        ...
                        <Col sm={12} md={6} lg={6} className={styles["passwordCheckBox"]}>
                            <p className="fw-bold m-0">Password must be</p>
                            <PasswordChecklist
                                ...
                                onChange={(isValid) => { console.log(isValid, "isValid", setPasswordStrong(isValid)) }}
                                invalidColor="red"
                                validColor='blue'
                                iconSize={"14px"}
                            />
                    ...
                    <Row className='my-2'>
                        <Col sm={12} md={6} lg={6}>Confirm Password</Col>
                        <Col sm={12} md={6} lg={6} className="position-relative">        <TextField
                            applyClass="form-control2"
                            className="PasswordTextField"
