...
const ViewDetailsModal = ({
  ...
  return (
    <section>
      <div className={styles["ViewDetails_paper"]}>
        <Row>
          <Col
            lg={11}
            md={11}
                  ...
                  <Col lg={12} md={12} sm={12} className={styles["Scroller"]}>
                    ...
                    <Row className='mt-2'>
                      <Col lg={2} md={2} sm={2} className='gap-3 d-flex'>
                        ...
                        />
                        <span className={styles["Vertical_Seperator"]}></span>
                      </Col>
                    ...
                    <Row className='mt-2'>
                      <Col lg={12} md={12} sm={12}>
                        <span className={styles["owned_heading"]}>
                          {`${t("Owned-by")} ${
                            Number(documentDetails?.ownerDetails?.userID) ===
                          ...
                          {documentDetails.sharedUsers.length > 0
                            ? documentDetails.sharedUsers.map((data, index) => (
                                <React.Fragment key={index}>
                                  {data.userName}
                                  {index <
                                    documentDetails.sharedUsers.length - 1 &&
                                    " and "}{" "}
                    ...
                    <Row className='mt-2'>
                      {documentDetails.sharedUsers.map((sharedData, index) => {
                        if (
                          Number(sharedData.userID) === Number(currentUserID) &&
                      ...
                      <Col lg={7} md={7} sm={7}>
                        ...
                        <Row className='mt-2'>
                          <Col
                            ...
                            <span
                              className={styles["DetialsHeading_subHeading"]}>
                              {formatMB(documentDetails?.sizeOnDisk)}
                            ...
                            <>
                              <Row className='mt-2'>
                                ...
                                <Col
                                  ...
                                  ) : Number(YesterDayData.actionID) === 2 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
                                        {YesterDayData?.description}
                                  ...
                                  ) : Number(YesterDayData.actionID) === 3 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
                                        {YesterDayData?.description}
                                  ...
                                  ) : Number(YesterDayData.actionID) === 4 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
                                        {YesterDayData?.description}
                            ...
                            <>
                              <Row className='mt-2'>
                                ...
                                <Col
                                  ...
                                  ) : Number(thisweekData.actionID) === 2 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
                                        {thisweekData?.description}
                                  ...
                                  ) : Number(thisweekData.actionID) === 3 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
                                        {thisweekData?.description}
                                  ...
                                  ) : Number(thisweekData.actionID) === 4 ? (
                                    <>
                                      {" "}
                                      <span
                                        className={styles["activity_heading"]}>
                            ...
                            <>
                              <Row className='mt-2'>
                                ...
                                <Col
                                  ...
                                  ) : Number(thisMonthData.actionID) === 2 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
                                        {thisMonthData?.description}
                                  ...
                                  ) : Number(thisMonthData.actionID) === 3 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
                                        {thisMonthData?.description}
                                  ...
                                  ) : Number(thisMonthData.actionID) === 4 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
                                        {thisMonthData?.description}
                            ...
                            <>
                              <Row className='mt-2'>
                                ...
                                <Col
                                  ...
                                  {Number(previousMonthData.actionID) === 1 ? (
                                    <>
                                      <span
                                        className={styles["activity_heading"]}>
