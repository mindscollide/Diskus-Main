                ...
                <Col sm={12} md={12} lg={12} className={styles["videochatContainer"]}>
                    ...
                    <Row className='mt-3'>
                        <Col sm={7} md={7} lg={7} className="bg-white">
                            <Row>
                                <Col sm={12}><h5 className={styles["minutes-recording"]}>Meeting Minutes</h5></Col>
                                <Col className={styles["meetingmeetininmeeting"]}>
                                    <Row className='mx-2'>
                                        <Col sm={12} className="border my-2 py-1 d-flex justify-content-start flex-column">
                                            <Row>
                                                <Col sm={1}>
                                ...
                                <Col sm={12}>
                                    <Row>
                                        <Col sm={11} md={11} lg={11} className={styles["minutes-input"]}>
                                            <TextField placeholder={"Type as"} width={"520"} value={minutes} change={(e) => setMinutes(e.target.value)} />
                                        </Col>
