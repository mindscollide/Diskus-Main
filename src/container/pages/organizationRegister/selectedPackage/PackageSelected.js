                ...
                <Col sm={12} lg={10} md={10} className="mx-auto">
                    <Row>
                        <Col className='d-flex justify-content-center mt-2'>
                            <h2 className={styles["selectedpackagepage_heading"]}>Selected Package</h2></Col>
                    </Row>
                    <Row>
                        <Col sm={12} lg={5} md={5}>
                            <PackageCards packageTitle="PREMIUM" selectedPackageAmount="55" SelectedPackgeSubscription="Yearly" />
                        </Col>
                        <Col sm={12} lg={7} md={7}>
                            <SelectedPackageCard RowsData={<>
                    ...
                    <Row className='my-3'>
                        <Col sm={12} md={6} lg={6} className="d-flex justify-content-start">
                            <Button text="Go Back" onClick={goBacktoSignUp} className={styles["goBack_SelectedPackage"]} />
                        </Col>
                        <Col sm={12} md={6} lg={6} className="d-flex justify-content-end p-0">
                            <Button text="Process To Payment" onClick={goForPayment} className={styles["ProcessToPayment_SelectedPackage"]} />
                        </Col>
