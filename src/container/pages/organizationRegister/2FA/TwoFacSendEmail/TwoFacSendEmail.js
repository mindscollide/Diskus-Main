                    ...
                    <Row>
                        ...
                        >
                            <Paper className="Send_Email_Realme">
                                <Col sm={12} lg={12} md={12} className="EmailVerifyBoxSendEmail">
                                    <Row>
                                        <Col
                                            sm={12}
                                            md={12}
                                    ...
                                    <Form>
                                        <Row className="my-0 FAsendEmailRealme">
                                            ...
                                            >
                                                <h3 className=" VerifyHeadingTwofacSendEmail ">2FA Verification</h3>
                                        ...
                                        <Row className="EmailBoxSendRealme">
                                            <Col sm={12} md={12} lg={12} className="mt-2">
                                                <Row>
                                                    ...
                                                    <Col sm={12} md={9} lg={9}> <span className={!notificationdevice ? "SendEmailOnDeiveColor_active" : "SendEmailOnDeiveColor"}>
                                                        SEND NOTIFICATION ON DEVICE
                                                    </span></Col>
                                                    <Col sm={12} md={2} lg={2}>

                                                        <Form.Check type="radio" onChange={changeHandler1} value={"SEND NOTIFICATION ON DEVICE"} name="2faverificationSendEmail" />
                                                    </Col>
                                                </Row>
                                            ...
                                            <Col sm={12} md={12} lg={12} className="mt-0">
                                                <Row className="my-1">
                                                    <Col sm={12} md={1} lg={1}><img width={"15px"} src={img5} alt="" /></Col>
                                                    <Col sm={12} md={9} lg={9} > <span className={!notificationemail ? "SendEmailOnDeiveColor_active" : "SendEmailOnDeiveColor"}>
                                                        SEND CODE ON EMAIL
                                                    </span></Col>
                                                    <Col sm={12} md={2} lg={2}>   <Form.Check onChange={changeHandler2} type="radio" value={"SEND CODE ON EMAIL"} name="2faverificationSendEmail" /></Col>
                                                </Row>

                                            </Col>
                                            <Col sm={12} md={12} lg={12} className="mt-1">
                                                <Row>
                                                    <Col sm={12} md={1} lg={1}> <img width={"15px"} src={img6} alt="" /></Col>
                                                    <Col sm={12} md={9} lg={9}>  <span className={!notificationsms ? "SendEmailOnDeiveColor_active" : "SendEmailOnDeiveColor"}>
                                                        SEND CODE ON SMS
                                                    </span></Col>
                                                    <Col sm={12} md={2} lg={2}><Form.Check onChange={changeHandler3} value={"SEND CODE ON SMS"} type="radio" name="2faverificationSendEmail" />  </Col>
                                                </Row>
                                            </Col>
                                        </Row>
