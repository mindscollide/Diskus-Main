...
const TwoFactor = () => {
    ...
    const onClickHnadler = (e) => {
        ...
        let Data = { UserID: JSON.parse(userID), Device: "Browser", DeviceID: "c", OrganizationID: JSON.parse(OrganizationID), isEmail: sendCodeEmail, isSMS: sendCodeEmailPhone, isDevice: false, UserDevices: [] }
                            ...
                            <Form>
                                <Row className="my-0">
                                    ...
                                    >
                                        ...
                                        <span className="SelectLinetwofac">Select Any One Option</span>
                                    </Col>
                                </Row>
                                ...
                                <Row className="EmailBoxtwofac">
                                    <Col sm={12} md={12} lg={12} className="mt-2">
                                        <Row>
                                            <Col sm={12} md={1} lg={1}> <img width={"15px"} src={img10} alt="" /></Col>
                                            <Col sm={12} md={9} lg={9}>  <span className={!sendCodeEmailPhone ? "EmailLabeltwofacboth_active " : " EmailLabeltwofacboth"}>SEND CODE ON SMS</span></Col>
                                            <Col sm={12} md={2} lg={2}> <Form.Check type="radio" name="TwoFactor" value={"SEND CODE ON SMS"} onChange={onChangeHandlerTwoFactor} /></Col>
                                        </Row>
                                        <Row className="mt-2">
                                            <Col sm={12} md={1} lg={1}> <img width={"17px"} src={img5} alt="" /></Col>
                                            <Col sm={12} md={9} lg={9}>  <span className={!sendCodeEmail ? "sendCodeEmail_active " : " sendCodeEmail"}>SEND CODE ON EMAIL</span></Col>
                                            <Col sm={12} md={2} lg={2}><Form.Check type="radio" name="TwoFactor" value={"SEND CODE ON EMAIL"} onChange={onChangeHandlerSendEmail} /></Col>
                                        </Row>
                                    </Col>
