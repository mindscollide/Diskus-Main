...
const OrganizationLevelConfigUM = () => {
    ...
    if (
      ...
      if (
        ...
        setAutoCloseResolution({
          value: organizationSettings.autoCloseResolutionDays,
          label: organizationSettings.autoCloseResolutionDays,
        });
        let timeZoneCode = {
  ...
  const updateOrganizationLevelSettings = async () => {
    ...
    let Data = {
      ...
      FiscalEndMonth: userOrganizationSetting.fiscalEndMonth,
                ...
                <>
                  <Row className="mt-3">
                    ...
                    >
                      ...
                      <Select
                        options={autoClosResolutionOptions}
                        // className={styles["selectDormant"]}
                        classNamePrefix={"select_dormant-days"}
                        value={autoCloseResolution}
                        onChange={handleChangeAutoCloseResolution}
                      />
                    </Col>
                  </Row>
                </>
