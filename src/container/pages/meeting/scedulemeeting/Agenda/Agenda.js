...
const Agenda = () => {
  ...
  const handleFilesDragSubAgenda = (result) => {
    ...
    setRows(updatedRows); // Update the state with the modified data
  };
                                                                      ...
                                                                      {row.subAgenda[0].Subfiles.map(
                                                                        (
                                                                          ...
                                                                          <Draggable
                                                                            ...
                                                                            draggableId={`subFile-${subFile.SubFilesID}`}
                                                                            index={
                                                                              index
                                                                            }
                                                                          >
                                                                            {(
                                                                              ...
                                                                              >
                                                                                {/* Render your sub-file content here */}
                                                                                <Row>
                                                                                  <Col
                                                                                    sm={
                                                                                      12
