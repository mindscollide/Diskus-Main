  ...
  const SubAgendaMappingDragging = (data, index) => {
    if (Object.keys(data).length > 0) {
      return (
        <>
          <Droppable
            key={`sub-agenda-${data.ID}`}
            droppableId={`sub-agenda-${data.ID}`}
            type={`sub-agenda-${data.ID}`}
          >
            {(provided) => (
                                      ...
                                      <Row className="mt-2 mb-2">
                                        ...
                                        <Col lg={3} md={3} sm={12}>
                                          ...
                                          <Select
                                            ...
                                            value={subAgendaData.selectedOption}
                                            onChange={(value) =>
                                          ...
                                          <Row>
                                            ...
                                            <Col lg={5} md={5} sm={5}>
                                              ...
                                              <DatePicker
                                                ...
                                                format="HH:mm A"
                                                selected={subAgendaData.endDate}
                                                onChange={(date) =>
          ...
          <section>
            <DragDropContext onDragEnd={onDragEnd}>
              <Row>
                ...
                >
                  <Droppable droppableId="main-agenda" type="main-agenda">
                    {(provided) => (
                      <div {...provided.droppableProps} ref={provided.innerRef}>
                        {rows.length > 0
                          ? rows.map((data, index) => {
                                  ...
                                  >
                                    {(provided) => (
                                      ...
                                      >
                                        ...
                                        {/* SubAgenda Mapping */}
                                        {SubAgendaMappingDragging(data, index)}
                                        {/* sub Ajenda Button */}
                                        <Row className="mt-3">
                                          <Col lg={12} md={12} sm={12}>
                                            <Button
