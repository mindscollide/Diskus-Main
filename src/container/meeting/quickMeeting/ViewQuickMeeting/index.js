  ...
  useEffect(() => {
    try {
      if (
        ...
        Object.keys(assigneesViewMeetingDetails).length > 0
      ) {
    ...
    try {
      if (calendarReducereventsDetails !== null) {
        ...
        setCreateMeeting({
          ...
          ExternalMeetingAttendees: externalMeetingAttendiesList,
          MinutesOfMeeting: minutesOfMeeting,
          VideoCallURL: calendarMeetingData.meetingDetails.videoCallURL,
        });
      ...
      if (
        ...
        await dispatch(
          LeaveMeetingApi(
            ...
            t,
            leaveMeetingData,
            "leaveQuickMeetingFromViewModal",
            { setIsQuickMeetingView },
          ),
        );
      ...
      if (!getMeetingVideoHost) {
        ...
        if (!enableDisableVideoState) {
          let data = {
            ...
            IsMuted: false,
            HideVideo: false,
            isHost: getMeetingVideoHost ? true : false,
          };
