...
const searchPaymentHistoryApi = (navigate, searchData, t, setPaymentHistoryModal, no) => {
    ...
    return (dispatch) => {
        ...
        form.append("RequestMethod", searchPaymentHistoryRequestMethod.RequestMethod);
        ...
        axios({
            ...
            if (response.data.responseCode === 417) {
                ...
                dispatch(searchPaymentHistoryApi(navigate, searchData, t, setPaymentHistoryModal))
                ...
                if (response.data.responseResult.isExecuted === true) {
                    if (response.data.responseResult.responseMessage.toLowerCase().includes("Admin_AdminServiceManager_InvoicesAndPaymentHistory_01".toLowerCase())) {
                        dispatch(searchPaymentHistory_success(response.data.responseResult, t("Data-available")))
                        if (no === 1) {
