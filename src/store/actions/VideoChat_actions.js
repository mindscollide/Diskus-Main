...
import { getAttachmentByMeetingId, getAgendasByMeetingId, updateAgendaAttachments } from '../../commen/apis/Api_config'
        ...
        axios({
            ...
            if (response.data.responseCode === 417) {
                ...
                if (response.data.responseResult.isExecuted === true) {
                    ...
                    dispatch(getMeetingAgendasSuccess
                        (
                            response.data.responseResult,
...
const getMeetingAttachments = (data) => {
    let token = JSON.parse(localStorage.getItem("token"));
    return (dispatch) => {
        ...
        axios({
            ...
            if (response.data.responseCode === 417) {
                ...
                if (response.data.responseResult.isExecuted === true) {
                    ...
                    dispatch(getMeetingAttachmentsSuccess
                        (
                            response.data.responseResult,
                            response.data.responseMessage
                        )
                ...
                await dispatch(getMeetingAttachmentsFail(response.data.responseMessage));
            }
        })
            .catch((response) => {
                console.log("response", response)
...
const updateAgendaAttachment = (data) => {
    let AgendaAttachments = { AgendaAttachments: [...data] }
    console.log("AgendaAttachmentsAgendaAttachmentsAgendaAttachmentsAgendaAttachmentsAgendaAttachments", JSON.stringify(AgendaAttachments))
    let token = JSON.parse(localStorage.getItem("token"));
    ...
    return (dispatch) => {
        ...
        axios({
            ...
            if (response.data.responseCode === 417) {
                ...
                if (response.data.responseResult.isExecuted === true) {
                    await dispatch(updateAgendaAttahmentsSuccess(response.data.responseResult, response.data.responseMessage));
                } else {
                   await dispatch(updateAgendaAttahmentsFail(response.data.responseMessage));
                }
            } else {
                await dispatch(updateAgendaAttahmentsFail(response.data.responseMessage));
            }
...
export { getMeetingAgendas, showMinutes, showAttachments, meetingModalAttachment, getMeetingAttachments, updateAgendaAttachment }