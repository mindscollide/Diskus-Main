...
export const SCHEDULE_NEW_MEETING_SUCCESS = "SCHEDULE_NEW_MEETING_SUCCESS";
...
export const SHOWMORE_UPCOMINGEVENTS_INIT = "SHOWMORE_UPCOMINGEVENTS_INIT";
export const SHOWMORE_UPCOMINGEVENTS_SUCCESS =
  "SHOWMORE_UPCOMINGEVENTS_SUCCESS";
export const SHOWMORE_UPCOMINGEVENTS_FAIL = "SHOWMORE_UPCOMINGEVENTS_FAIL";
...
export const CLEARE_MESSAGE_RESPONCE = "CLEARE_MESSAGE_RESPONCE";
...
export const GROUP_CALL_MISSED_BY_ME_MQTT = "GROUP_CALL_MISSED_BY_ME_MQTT";
...
export const CLEAR_GET_USER_WISE_PROPOSED = "CLEAR_GET_USER_WISE_PROPOSED";
...
export const CLEAR_GET_MEETING_BY_COMMITTEE_ID =
  "CLEAR_GET_MEETING_BY_COMMITTEE_ID";
...
export const CLEAR_GET_MEETING_BY_GROUP_ID = "CLEAR_GET_MEETING_BY_GROUP_ID";
...
export const VALIDATE_ENCRYPTEDSTRING_EMAIL_RELATED_CLEAR =
  "VALIDATE_ENCRYPTEDSTRING_EMAIL_RELATED_CLEAR";
...
export const GET_PENDINGAPPROVALSCOUNT_CLEAR =
  "GET_PENDINGAPPROVALSCOUNT_CLEAR";
...
export const GET_MEETING_GUEST_URL_FAIL = "GET_MEETING_GUEST_URL_FAIL";
...
export const VALIDATE_ENCRYPT_STRING_GUEST_VIDEO_INIT =
  "VALIDATE_ENCRYPT_STRING_GUEST_VIDEO_INIT";
export const VALIDATE_ENCRYPT_STRING_GUEST_VIDEO_SUCCESS =
  "VALIDATE_ENCRYPT_STRING_GUEST_VIDEO_SUCCESS";
export const VALIDATE_ENCRYPT_STRING_GUEST_VIDEO_FAIL =
  "VALIDATE_ENCRYPT_STRING_GUEST_VIDEO_FAIL";

export const GUEST_JOIN_POPUP = "GUEST_JOIN_POPUP";

export const JOIN_GUEST_VIDEO_INIT = "JOIN_GUEST_VIDEO_INIT";
export const JOIN_GUEST_VIDEO_SUCCESS = "JOIN_GUEST_VIDEO_SUCCESS";
export const JOIN_GUEST_VIDEO_FAIL = "JOIN_GUEST_VIDEO_FAIL";

export const CLEAR_RESPONSEMESSAGE_GUESTREDUCER =
  "CLEAR_RESPONSEMESSAGE_GUESTREDUCER";

export const SET_MQTT_GUEST = "SET_MQTT_GUEST";
export const ADMIT_REJECT_ATTENDEE_INIT = "ADMIT_REJECT_ATTENDEE_INIT";
export const ADMIT_REJECT_ATTENDEE_SUCCESS = "ADMIT_REJECT_ATTENDEE_SUCCESS";
export const ADMIT_REJECT_ATTENDEE_FAIL = "ADMIT_REJECT_ATTENDEE_FAIL";

export const CLEAR_GUEST_MEETING_MESSAGES = "CLEAR_GUEST_MEETING_MESSAGES";

export const ADMIT_GUEST_USER_REQUEST = "ADMIT_GUEST_USER_REQUEST";

export const GUEST_VIDEO_SCREEN_NAVIGATION = "GUEST_VID zEO_SCREEN_NAVIGATION";

export const PARTICIPANT_LIST_USERS = "PARTICIPANT_LIST_USERS";

export const PARTICIPANT_JOINT_REQUESTS = "PARTICIPANT_JOINT_REQUESTS";

export const ACCEPT_AND_REMOVE_PARTICIPANTS = "ACCEPT_AND_REMOVE_PARTICIPANTS";

export const RAISE_UNRAISED_HAND_INIT = "RAISE_UNRAISED_HAND_INIT";
export const RAISE_UNRAISED_HAND_SUCCESS = "RAISE_UNRAISED_HAND_SUCCESS";
export const RAISE_UNRAISED_HAND_FAIL = "RAISE_UNRAISED_HAND_FAIL";

export const MUTE_UNMUTE_PARTICIPANT_INIT = "MUTE_UNMUTE_PARTICIPANT_INIT";
export const MUTE_UNMUTE_PARTICIPANT_SUCCESS =
  "MUTE_UNMUTE_PARTICIPANT_SUCCESS";
export const MUTE_UNMUTE_PARTICIPANT_FAIL = "MUTE_UNMUTE_PARTICIPANT_FAIL";

export const TRANSFER_MEETING_HOST_INIT = "TRANSFER_MEETING_HOST_INIT";
export const TRANSFER_MEETING_HOST_SUCCESS = "TRANSFER_MEETING_HOST_SUCCESS";
export const TRANSFER_MEETING_HOST_FAIL = "TRANSFER_MEETING_HOST_FAIL";

export const REMOVE_PARTICIPANT_FROM_MEETING_INIT =
  "REMOVE_PARTICIPANT_FROM_MEETING_INIT";
export const REMOVE_PARTICIPANT_FROM_MEETING_SUCCESS =
  "REMOVE_PARTICIPANT_FROM_MEETING_SUCCESS";
export const REMOVE_PARTICIPANT_FROM_MEETING_FAIL =
  "REMOVE_PARTICIPANT_FROM_MEETING_FAIL";

// CR(0012249) — Presentation waiting-room / admit-reject / remove flow
export const JOIN_PRESENTATION_REQUEST_INIT = "JOIN_PRESENTATION_REQUEST_INIT";
export const JOIN_PRESENTATION_REQUEST_SUCCESS =
  "JOIN_PRESENTATION_REQUEST_SUCCESS";
export const JOIN_PRESENTATION_REQUEST_FAIL = "JOIN_PRESENTATION_REQUEST_FAIL";

export const ADMIT_REJECT_PRESENTATION_ATTENDEE_INIT =
  "ADMIT_REJECT_PRESENTATION_ATTENDEE_INIT";
export const ADMIT_REJECT_PRESENTATION_ATTENDEE_SUCCESS =
  "ADMIT_REJECT_PRESENTATION_ATTENDEE_SUCCESS";
export const ADMIT_REJECT_PRESENTATION_ATTENDEE_FAIL =
  "ADMIT_REJECT_PRESENTATION_ATTENDEE_FAIL";

export const REMOVE_PARTICIPANT_FROM_PRESENTATION_INIT =
  "REMOVE_PARTICIPANT_FROM_PRESENTATION_INIT";
export const REMOVE_PARTICIPANT_FROM_PRESENTATION_SUCCESS =
  "REMOVE_PARTICIPANT_FROM_PRESENTATION_SUCCESS";
export const REMOVE_PARTICIPANT_FROM_PRESENTATION_FAIL =
  "REMOVE_PARTICIPANT_FROM_PRESENTATION_FAIL";

export const SET_PARTICIPANT_NAME = "SET_PARTICIPANT_NAME";

export const GUEST_VIDEO_LEAVE_MEETING_INIT = "GUEST_VIDEO_LEAVE_MEETING_INIT";
export const GUEST_VIDEO_LEAVE_MEETING_SUCCESS =
  "GUEST_VIDEO_LEAVE_MEETING_SUCCESS";
export const GUEST_VIDEO_LEAVE_MEETING_FAIL = "GUEST_VIDEO_LEAVE_MEETING_FAIL";

export const REMOVE_PARTICIPANTS_FROM_VIDEO = "REMOVE_PARTICIPANTS_FROM_VIDEO";

export const MUTE_UNMUTE_SELF_INIT = "MUTE_UNMUTE_SELF_INIT";
export const MUTE_UNMUTE_SELF_SUCCESS = "MUTE_UNMUTE_SELF_SUCCESS";
export const MUTE_UNMUTE_SELF_FAIL = "MUTE_UNMUTE_SELF_FAIL";
export const MEETING_REMINDER_NOTIFICATION = "MEETING_REMINDER_NOTIFICATION";

export const GUEST_PARTICIPANT_LEAVE_VIDEO = "GUEST_PARTICIPANT_LEAVE_VIDEO";
export const PARTICIPANT_MUTEUNMUTE_VIDEO = "PARTICIPANT_MUTEUNMUTE_VIDEO";
export const PARTICIPANT_RAISEDUNRAISEDHAND_VIDEO =
  "PARTICIPANT_RAISEDUNRAISEDHAND_VIDEO";
export const RESET_RAISED_HAND_GUIDS = "RESET_RAISED_HAND_GUIDS";

export const HIDE_UNHIDE_SELF_VIDEO_INIT = "HIDE_UNHIDE_SELF_VIDEO_INIT";
export const HIDE_UNHIDE_SELF_VIDEO_SUCCESS = "HIDE_UNHIDE_SELF_VIDEO_SUCCESS";
export const HIDE_UNHIDE_SELF_VIDEO_FAIL = "HIDE_UNHIDE_SELF_VIDEO_FAIL";

export const PARTICIPANT_HIDEUNHIDE_VIDEO = "PARTICIPANT_HIDEUNHIDE_VIDEO";

// when Host Mute and Unmute participant or Guest
export const MUTE_UNMUTE_PARTICIPANT_OR_GUEST =
  "MUTE_UNMUTE_PARTICIPANT_OR_GUEST";

// when Host Hide or unhide participant or guest video
export const HIDE_UNHIDE_PARTICIPANT_GUEST_VIDEO_INIT =
  "HIDE_UNHIDE_PARTICIPANT_GUEST_VIDEO_INIT";
export const HIDE_UNHIDE_PARTICIPANT_GUEST_VIDEO_SUCCESS =
  "HIDE_UNHIDE_PARTICIPANT_GUEST_VIDEO_SUCCESS";
export const HIDE_UNHIDE_PARTICIPANT_GUEST_VIDEO_FAIL =
  "HIDE_UNHIDE_PARTICIPANT_GUEST_VIDEO_FAIL";

export const HIDE_UNHIDE_VIDEO_BY_HOST = "HIDE_UNHIDE_VIDEO_BY_HOST";
...
export const SET_INITIAL_ALLSTATE = "SET_INITIAL_ALLSTATE";

export const PARTICIPANT_SAVED_PROPOSED_NEW_MEETING_INIT =
  "PARTICIPANT_SAVED_PROPOSED_NEW_MEETING_INIT";
export const PARTICIPANT_SAVED_PROPOSED_NEW_MEETING_SUCCESS =
  "PARTICIPANT_SAVED_PROPOSED_NEW_MEETING_SUCCESS";
export const PARTICIPANT_SAVED_PROPOSED_NEW_MEETING_FAIL =
  "PARTICIPANT_SAVED_PROPOSED_NEW_MEETING_FAIL";

export const SET_MQTT_VIDEO_CAMERA_GUEST = "SET_MQTT_VIDEO_CAMERA_GUEST";
export const SET_MQTT_VOICE_CONTROLE_GUEST = "SET_MQTT_VOICE_CONTROLE_GUEST";
export const GETMEETINGCOUNT_DASHBOARD_MQTT = "GETMEETINGCOUNT_DASHBOARD_MQTT";
export const GETTASKCOUNT_DASHBOARD_MQTT = "GETTASKCOUNT_DASHBOARD_MQTT";
export const GETPENDINGAPPROVALCOUNT_DASHBOARD_MQTT =
  "GETPENDINGAPPROVALCOUNT_DASHBOARD_MQTT";
export const UNSAVED_NEW_AGENDA_CANCEL_MODAL =
  "UNSAVED_NEW_AGENDA_CANCEL_MODAL";

export const SHARE_VIA_DATAROOM_PATH_CONFIRMATION =
  "SHARE_VIA_DATAROOM_PATH_CONFIRMATION";
export const VALIDATEENCRYPTEDSTRINGUSERMEETINGPROPOSEDATESPOLL_INIT =
  "VALIDATEENCRYPTEDSTRINGUSERMEETINGPROPOSEDATESPOLL_INI";
export const VALIDATEENCRYPTEDSTRINGUSERMEETINGPROPOSEDATESPOLL_SUCCESS =
  "VALIDATEENCRYPTEDSTRINGUSERMEETINGPROPOSEDATESPOLL_SUCCESS";
export const VALIDATEENCRYPTEDSTRINGUSERMEETINGPROPOSEDATESPOLL_FAIL =
  "VALIDATEENCRYPTEDSTRINGUSERMEETINGPROPOSEDATESPOLL_FAIL";

export const GET_VIDEO_PARTICIPANTS_FOR_GUEST_INIT =
  "GET_VIDEO_PARTICIPANTS_FOR_GUEST_INIT";
export const GET_VIDEO_PARTICIPANTS_FOR_GUEST_SUCCESS =
  "GET_VIDEO_PARTICIPANTS_FOR_GUEST_SUCCESS";
export const GET_VIDEO_PARTICIPANTS_FOR_GUEST_FAIL =
  "GET_VIDEO_PARTICIPANTS_FOR_GUEST_FAIL";

export const GET_VALIDATE_STRING_DATA = "GET_VALIDATE_STRING_DATA";

export const GET_MEETING_NEW_PARTICIPANT_JOIN =
  "GET_MEETING_NEW_PARTICIPANT_JOIN";

export const REMOVE_CALENDARMEETINGDATA = "REMOVE_CALENDARMEETINGDATA";

export const RAISE_UNRAISED_PARTICIPANTS_GUEST =
  "RAISE_UNRAISED_PARTICIPANTS_GUEST";

export const HIDE_UNHIDE_VIDEO_PARTICIPANTS_GUEST =
  "HIDE_UNHIDE_VIDEO_PARTICIPANTS_GUEST";

export const MUTE_UNMUTE_PARTICIPANTS_GUEST = "MUTE_UNMUTE_PARTICIPANTS_GUEST";

export const JOIN_MEETING_VIDEO_REQUEST_INIT =
  "JOIN_MEETING_VIDEO_REQUEST_INIT";
export const JOIN_MEETING_VIDEO_REQUEST_SUCCESS =
  "JOIN_MEETING_VIDEO_REQUEST_SUCCESS";
export const JOIN_MEETING_VIDEO_REQUEST_FAIL =
  "JOIN_MEETING_VIDEO_REQUEST_FAIL";

export const MAX_HOST_VIDEO_CALL_PANEL = "MAX_HOST_VIDEO_CALL_PANEL";
export const NORMAL_HOST_VIDEO_CALL_PANEL = "NORMAL_HOST_VIDEO_CALL_PANEL";

export const MAX_PARTICIPANT_VIDEO_CALL_PANEL =
  "MAX_PARTICIPANT_VIDEO_CALL_PANEL";

// CR(0012249) — tells maxParticipantVideoCallComponent whether it's being
// used for a Presentation join (waiting room + mic/cam force-lock) vs its
// original Meeting-Video join. Default false everywhere existing code
...
export const GET_VIDEO_CALL_PARTICIPANT_AND_WAITING_LIST_INIT =
  "GET_VIDEO_CALL_PARTICIPANT_AND_WAITING_LIST_INIT";
export const GET_VIDEO_CALL_PARTICIPANT_AND_WAITING_LIST_SUCCESS =
  "GET_VIDEO_CALL_PARTICIPANT_AND_WAITING_LIST_SUCCESS";
export const GET_VIDEO_CALL_PARTICIPANT_AND_WAITING_LIST_FAIL =
  "GET_VIDEO_CALL_PARTICIPANT_AND_WAITING_LIST_FAIL";

export const PARTICIPANT_VIDEO_SCREEN_NAVIGATION =
  "PARTICIPANT_VIDEO_SCREEN_NAVIGATION";

export const GETSIGNATUREFILEANNOTATION_INIT =
  "GETSIGNATUREFILEANNOTATION_INIT";
export const GETSIGNATUREFILEANNOTATION_SUCCESS =
  "GETSIGNATUREFILEANNOTATION_SUCCESS";
export const GETSIGNATUREFILEANNOTATION_FAIL =
  "GETSIGNATUREFILEANNOTATION_FAIL";

export const ADDUPDATESIGNATUREFILEANNOTATION_INIT =
  "ADDUPDATESIGNATUREFILEANNOTATION_INIT";
export const ADDUPDATESIGNATUREFILEANNOTATION_SUCCESS =
  "ADDUPDATESIGNATUREFILEANNOTATION_SUCCESS";
export const ADDUPDATESIGNATUREFILEANNOTATION_FAIL =
  "ADDUPDATESIGNATUREFILEANNOTATION_FAIL";

export const CURRENT_URL_CHECK = "CURRENT_URL_CHECK";

export const INTIMATION_MESSEGE_LEAVE_MEETING_VIDEO =
  "INTIMATION_MESSEGE_LEAVE_MEETING_VIDEO";
// for Host Voice Control
export const SET_MQTT_VOICE_CONTROLE_HOST = "SET_MQTT_VOICE_CONTROLE_HOST";
...
export const MAX_PARTICIPANT_VIDEO_DENIED = "MAX_PARTICIPANT_VIDEO_DENIED";
export const MAX_PARTICIPANT_VIDEO_REMOVED = "MAX_PARTICIPANT_VIDEO_REMOVED";
export const PARTICIPANT_REMOVED_FROM_VIDEO_BY_HOST =
  "PARTICIPANT_REMOVED_FROM_VIDEO_BY_HOST";
export const PARTICIPANT_LEAVE_CALL_FOR_JOIN_NON_MEETING_CALL =
  "PARTICIPANT_LEAVE_CALL_FOR_JOIN_NON_MEETING_CALL";

// mike and video for panels
export const MIC_ENABLE_WHEN_HOST_PANEL_MIC_ENABLE =
  "MIC_ENABLE_WHEN_HOST_PANEL_MIC_ENABLE";
export const VIDEO_ENABLE_WHEN_HOST_PANEL_VIDEO_ENABLE =
  "VIDEO_ENABLE_WHEN_HOST_PANEL_VIDEO_ENABLE";

export const VIDEO_PARTICIPANT_NON_GUEST_LEFT =
  "VIDEO_PARTICIPANT_NON_GUEST_LEFT";

export const MAIN_PARTICIPANT_HIDE_UNHIDE_VIDEO =
  "MAIN_PARTICIPANT_HIDE_UNHIDE_VIDEO";

// for participant video it self
export const GET_VIDEO_PARTICIPANTS_FOR_INIT =
  "GET_VIDEO_PARTICIPANTS_FOR_INIT";
export const GET_VIDEO_PARTICIPANTS_FOR_SUCCESS =
  "GET_VIDEO_PARTICIPANTS_FOR_SUCCESS";
export const GET_VIDEO_PARTICIPANTS_FOR_FAIL =
  "GET_VIDEO_PARTICIPANTS_FOR_FAIL";

export const LEAVE_MODAL_SIDEBAR = "LEAVE_MODAL_SIDEBAR";
...
export const DISKUS_WEB_NOTIFICATION_SUCCESS =
  "DISKUS_WEB_NOTIFICATION_SUCCESS";
export const DISKUS_WEB_NOTIFICATION_FAIL = "DISKUS_WEB_NOTIFICATION_FAIL";

export const DISKUS_WEB_NOTIFICATION_MARKASREAD_INIT =
  "DISKUS_WEB_NOTIFICATION_MARKASREAD_INIT";
export const DISKUS_WEB_NOTIFICATION_MARKASREAD_SUCCESS =
  "DISKUS_WEB_NOTIFICATION_MARKASREAD_SUCCESS";
export const DISKUS_WEB_NOTIFICATION_MARKASREAD_FAIL =
  "DISKUS_WEB_NOTIFICATION_MARKASREAD_FAIL";
...
//Check Meeting Status API
export const GET_MEETING_STATUS_INIT = "GET_MEETING_STATUS_INIT";
export const GET_MEETING_STATUS_SUCCESS = "GET_MEETING_STATUS_SUCCESS";
export const GET_MEETING_STATUS_FAIL = "GET_MEETING_STATUS_FAIL";

export const DATAROOM_BREADCRUMBS = "DATAROOM_BREADCRUMBS";
export const GUEST_VIDEO_STREAM_STOP = "GUEST_VIDEO_STREAM_STOP";
export const MUTE_UNMUTE_PARTICIPANTS_GUEST_BY_HOST =
  "MUTE_UNMUTE_PARTICIPANTS_GUEST_BY_HOST";
export const SET_MQTT_VOICE_CONTROLE_GUEST_FOR_ALL_BY_HOST =
  "SET_MQTT_VOICE_CONTROLE_GUEST_FOR_ALL_BY_HOST";
export const LEAVE_MEETING_ON_LOGOUT = "LEAVE_MEETING_ON_LOGOUT";
export const LEAVE_MEETING_VIDEO_ON_LOGOUT = "LEAVE_MEETING_VIDEO_ON_LOGOUT";

export const MAKE_A_PARTICIPANT_HOST = "MAKE_A_PARTICIPANT_HOST";

//Data Room Files Shared persmission
export const DATAROOM_FILE_SHARED_PERMISSION_INIT =
  "DATAROOM_FILE_SHARED_PERMISSION_INIT";
export const DATAROOM_FILE_SHARED_PERMISSION_SUCCESS =
  "DATAROOM_FILE_SHARED_PERMISSION_SUCCESS";
export const DATAROOM_FILE_SHARED_PERMISSION_FAILED =
  "DATAROOM_FILE_SHARED_PERMISSION_FAILED";

export const REMOVE_PARTICIPANT_FROM_UPCOMINGEVENTS =
  "REMOVE_PARTICIPANT_FROM_UPCOMINGEVENTS";

export const NON_MEETING_VIDEO_MODAL = "NON_MEETING_VIDEO_MODAL";

//Minutes workFlow Actor Status Web Notification
export const MINUTES_WORKFLOW_ACTOR_STATUS_INIT =
  "MINUTES_WORKFLOW_ACTOR_STATUS_INIT";
export const MINUTES_WORKFLOW_ACTOR_STATUS_SUCCESS =
  "MINUTES_WORKFLOW_ACTOR_STATUS_SUCCESS";
export const MINUTES_WORKFLOW_ACTOR_STATUS_FAIL =
  "MINUTES_WORKFLOW_ACTOR_STATUS_FAIL";
...
export const VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_LIST_LINK_INIT =
  "VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_LIST_LINK_INIT";
export const VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_LIST_LINK_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_LIST_LINK_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_LIST_LINK_FAIL =
  "VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_LIST_LINK_FAIL";

export const VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_DETAILS_LINK_INIT =
  "VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_DETAILS_LINK_INIT";
export const VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_DETAILS_LINK_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_DETAILS_LINK_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_DETAILS_LINK_FAIL =
  "VALIDATE_ENCRYPTED_STRING_VIEW_COMMITTEE_DETAILS_LINK_FAIL";

// Groups
export const VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_DETAILS_LINK_INIT =
  "VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_DETAILS_LINK_INIT";
export const VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_DETAILS_LINK_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_DETAILS_LINK_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_DETAILS_LINK_FAIL =
  "VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_DETAILS_LINK_FAIL";

export const VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_LIST_LINK_INIT =
  "VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_LIST_LINK_INIT";
export const VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_LIST_LINK_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_LIST_LINK_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_LIST_LINK_FAIL =
  "VALIDATE_ENCRYPTED_STRING_VIEW_GROUP_LIST_LINK_FAIL";

// Dataroom
export const VALIDATE_ENCRYPTED_STRING_VIEW_FILE_LINK_INIT =
  "VALIDATE_ENCRYPTED_STRING_VIEW_FILE_LINK_INIT";
export const VALIDATE_ENCRYPTED_STRING_VIEW_FILE_LINK_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_VIEW_FILE_LINK_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_VIEW_FILE_LINK_FAIL =
  "VALIDATE_ENCRYPTED_STRING_VIEW_FILE_LINK_FAIL";

export const VALIDATE_ENCRYPTED_STRING_VIEW_FOLDER_LINK_INIT =
  "VALIDATE_ENCRYPTED_STRING_VIEW_FOLDER_LINK_INIT";
export const VALIDATE_ENCRYPTED_STRING_VIEW_FOLDER_LINK_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_VIEW_FOLDER_LINK_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_VIEW_FOLDER_LINK_FAIL =
  "VALIDATE_ENCRYPTED_STRING_VIEW_FOLDER_LINK_FAIL";

// Meeting

export const VALIDATE_ENCRYPTED_STRING_MEETING_RELATED_EMAIL_DATA_INIT =
  "VALIDATE_ENCRYPTED_STRING_MEETING_RELATED_EMAIL_DATA_INIT";
export const VALIDATE_ENCRYPTED_STRING_MEETING_RELATED_EMAIL_DATA_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_MEETING_RELATED_EMAIL_DATA_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_MEETING_RELATED_EMAIL_DATA_FAIL =
  "VALIDATE_ENCRYPTED_STRING_MEETING_RELATED_EMAIL_DATA_FAIL";

// Task
export const VALIDATE_ENCRYPTED_STRING_VIEW_TASK_DETAILS_LINK_INIT =
  "VALIDATE_ENCRYPTED_STRING_VIEW_TASK_DETAILS_LINK_INIT";
export const VALIDATE_ENCRYPTED_STRING_VIEW_TASK_DETAILS_LINK_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_VIEW_TASK_DETAILS_LINK_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_VIEW_TASK_DETAILS_LINK_FAIL =
  "VALIDATE_ENCRYPTED_STRING_VIEW_TASK_DETAILS_LINK_FAIL";

export const VALIDATE_ENCRYPTED_STRING_VIEW_TASK_LIST_LINK_INIT =
  "VALIDATE_ENCRYPTED_STRING_VIEW_TASK_LIST_LINK_INIT";
export const VALIDATE_ENCRYPTED_STRING_VIEW_TASK_LIST_LINK_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_VIEW_TASK_LIST_LINK_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_VIEW_TASK_LIST_LINK_FAIL =
  "VALIDATE_ENCRYPTED_STRING_VIEW_TASK_LIST_LINK_FAIL";
//For Close QuickMeeting Video Call
export const CLOSE_VIDEOCALL_QUICK_MEETING = "CLOSE_VIDEOCALL_QUICK_MEETING";

//For Close QuickMeeting Modal Call
export const CLOSE_QUICK_MEETING_VIDEO_MODAL =
  "CLOSE_QUICK_MEETING_VIDEO_MODAL";

//For End Video Status Mqtt Response
export const LEAVE_MEETINGVIDEO_END_STATUS_RESPONSE =
  "LEAVE_MEETINGVIDEO_END_STATUS_RESPONSE";
...
export const CREATE_UPDATE_NOTES_DATAROOM_MAP_SUCCESS =
  "CREATE_UPDATE_NOTES_DATAROOM_MAP_SUCCESS";

export const CREATE_UPDATE_NOTES_DATAROOM_MAP_FAIL =
  "CREATE_UPDATE_NOTES_DATAROOM_MAP_FAIL";

//Save Notes Document
export const SAVE_NOTES_DOCUMENT_INIT = "SAVE_NOTES_DOCUMENT_INIT";
export const SAVE_NOTES_DOCUMENT_SUCCESS = "SAVE_NOTES_DOCUMENT_SUCCESS";
export const SAVE_NOTES_DOCUMENT_FAILED = "SAVE_NOTES_DOCUMENT_FAILED";

//Retrive Notes Document
export const RETRIEVE_NOTES_DOCUMENT_INIT = "RETRIEVE_NOTES_DOCUMENT_INIT";
export const RETRIEVE_NOTES_DOCUMENT_SUCCESS =
  "RETRIEVE_NOTES_DOCUMENT_SUCCESS";
export const RETRIEVE_NOTES_DOCUMENT_FAILED = "RETRIEVE_NOTES_DOCUMENT_FAILED";

// Save File Notes
export const SAVE_FILES_NOTES_INIT = "SAVE_FILES_NOTES_INIT";
export const SAVE_FILES_NOTES_SUCCESS = "SAVE_FILES_NOTES_SUCCESS";
export const SAVE_FILES_NOTES_FALSE = "SAVE_FILES_NOTES_FALSE";

//Upload Document Notes
export const UPLOAD_DOCUMENT_NOTES_INIT = "UPLOAD_DOCUMENT_NOTES_INIT";
export const UPLOAD_DOCUMENT_NOTES_SUCCESS = "UPLOAD_DOCUMENT_NOTES_SUCCESS";
export const UPLOAD_DOCUMENT_NOTES_FAILED = "UPLOAD_DOCUMENT_NOTES_FAILED";

export const CAST_VOTE_POLL_MODAL = "CAST_VOTE_POLL_MODAL";
//Web Notification Click Data For Video Initmination Modal
export const WEB_NOTIFICATION_DATA_VIDEO_INITIMINATION =
  "WEB_NOTIFICATION_DATA_VIDEO_INITIMINATION";

//Global True Flag for Notification Global Function
export const GLOBAL_FLAG_WEB_NOTIFICATION_FUNCTION =
  "GLOBAL_FLAG_WEB_NOTIFICATION_FUNCTION";

export const POLL_ID_FOR_CAST_VOTE = "POLL_ID_FOR_CAST_VOTE";

export const QUICKMEETING_DOCUMENTS_UPLOAD_INIT =
  "QUICKMEETING_DOCUMENTS_UPLOAD_INIT";
export const QUICKMEETING_DOCUMENTS_UPLOAD_SUCCESS =
  "QUICKMEETING_DOCUMENTS_UPLOAD_SUCCESS";
export const QUICKMEETING_DOCUMENTS_UPLOAD_FAIL =
  "QUICKMEETING_DOCUMENTS_UPLOAD_FAIL";

export const QUICKMEETING_SAVE_DOCUMENTS_INIT =
  "QUICKMEETING_SAVE_DOCUMENTS_INIT";
export const QUICKMEETING_SAVE_DOCUMENTS_SUCCESS =
  "QUICKMEETING_SAVE_DOCUMENTS_SUCCESS";
export const QUICKMEETING_SAVE_DOCUMENTS_FAIL =
  "QUICKMEETING_SAVE_DOCUMENTS_FAIL";

export const MOVEFILEANDFODLER_INIT = "MOVEFILEANDFODLER_INIT";
export const MOVEFILEANDFODLER_SUCCESS = "MOVEFILEANDFODLER_SUCCESS";
export const MOVEFILEANDFODLER_FAIL = "MOVEFILEANDFODLER_FAIL";
//Delete Notes Documents
export const DELETE_NOTES_DOCUMENTS_INIT = "DELETE_NOTES_DOCUMENTS_INIT";
export const DELETE_NOTES_DOCUMENTS_SUCCESS = "DELETE_NOTES_DOCUMENTS_SUCCESS";
export const DELETE_NOTES_DOCUMENTS_FAIL = "DELETE_NOTES_DOCUMENTS_FAIL";

// Global state for start and stop Presenter
// export const START_OR_STOP_PRESENTER_STATE = "START_OR_STOP_PRESENTER_STATE";

export const SET_LOADER_FALSE_GETLISTOFASSIGNEES =
  "SET_LOADER_FALSE_GETLISTOFASSIGNEES";

export const DISABLE_BUTTONS_ZOOM_BEFORE_JOIN_SESSION =
  "DISABLE_BUTTONS_ZOOM_BEFORE_JOIN_SESSION";
//Updated Cast Vote
export const UPDATED_CASTVOTE_INIT = "UPDATED_CASTVOTE_INIT";
export const UPDATED_CASTVOTE_SUCCESS = "UPDATED_CASTVOTE_SUCCESS";
export const UPDATED_CASTVOTE_FAIL = "UPDATED_CASTVOTE_FAIL";

//POlls Error Screeen
export const ACCESS_DENIED_NOTIFCATION = "ACCESS_DENIED_NOTIFCATION";
...
export const OPEN_PRESENTER_VIEW_FAIL = "OPEN_PRESENTER_VIEW_FAIL";

//For Start Presenter View
export const START_PRESENTER_VIEW_INIT = "START_PRESENTER_VIEW_INIT";
export const START_PRESENTER_VIEW_SUCCESS = "START_PRESENTER_VIEW_SUCCESS";
export const START_PRESENTER_VIEW_FAIL = "START_PRESENTER_VIEW_FAIL";

//For Stop Presenter View
export const STOP_PRESENTER_VIEW_INIT = "STOP_PRESENTER_VIEW_INIT";
export const STOP_PRESENTER_VIEW_SUCCESS = "STOP_PRESENTER_VIEW_SUCCESS";
export const STOP_PRESENTER_VIEW_FAIL = "STOP_PRESENTER_VIEW_FAIL";

//For Join Presenter View
export const JOIN_PRESENTER_VIEW_INIT = "JOIN_PRESENTER_VIEW_INIT";
export const JOIN_PRESENTER_VIEW_SUCCESS = "JOIN_PRESENTER_VIEW_SUCCESS";
export const JOIN_PRESENTER_VIEW_FAIL = "JOIN_PRESENTER_VIEW_FAIL";

//For Leave Presenter View
export const LEAVE_PRESENTER_VIEW_INIT = "LEAVE_PRESENTER_VIEW_INIT";
export const LEAVE_PRESENTER_VIEW_SUCCESS = "LEAVE_PRESENTER_VIEW_SUCCESS";
export const LEAVE_PRESENTER_VIEW_FAIL = "LEAVE_PRESENTER_VIEW_FAIL";
export const VALIDATE_ENCRYPTED_MINUTES_ADD_REVIEWER_INIT =
  "VALIDATE_ENCRYPTED_MINUTES_ADD_REVIEWER_INIT";
export const VALIDATE_ENCRYPTED_MINUTES_ADD_REVIEWER_SUCCESS =
  "VALIDATE_ENCRYPTED_MINUTES_ADD_REVIEWER_SUCCESS";
export const VALIDATE_ENCRYPTED_MINUTES_ADD_REVIEWER_FAIL =
  "VALIDATE_ENCRYPTED_MINUTES_ADD_REVIEWER_FAIL";
export const VALIDATE_ENCRYPTED_MINUTES_ADD_REVIEWER_CLEAR =
  "VALIDATE_ENCRYPTED_MINUTES_ADD_REVIEWER_CLEAR";

// Stop Meeting Video By presenter View when Some one Already Join the meeting Video

export const STOP_MEETING_VIDEO_BY_PRESENTER_VIEW =
  "STOP_MEETING_VIDEO_BY_PRESENTER_VIEW";

// For Presenter Join Started Main State

export const PRESENTER_STARTED_MAIN_FLAG = "PRESENTER_STARTED_MAIN_FLAG";
export const WORKFLOW_SIGNATURE_DOCUMENT_RECEIVED_BY_ME =
...
export const SIGNATURE_DOCUMENT_STATUS_CHANGE =
  "SIGNATURE_DOCUMENT_STATUS_CHANGE";
export const SIGNATURE_DOCUMENT_STATUS_CHANGE_FOR_SIGNEES =
  "SIGNATURE_DOCUMENT_STATUS_CHANGE_FOR_SIGNEES ";

export const VALIDATE_ENCRYPTED_STRING_SIGNATURE_DATA_INIT =
  "VALIDATE_ENCRYPTED_STRING_SIGNATURE_DATA_INIT";
export const VALIDATE_ENCRYPTED_STRING_SIGNATURE_DATA_SUCCESS =
  "VALIDATE_ENCRYPTED_STRING_SIGNATURE_DATA_SUCCESS";
export const VALIDATE_ENCRYPTED_STRING_SIGNATURE_DATA_FAIL =
  "VALIDATE_ENCRYPTED_STRING_SIGNATURE_DATA_FAIL";
export const VALIDATE_ENCRYPTED_STRING_SIGNATURE_DATA_CLEAR =
  "VALIDATE_ENCRYPTED_STRING_SIGNATURE_DATA_CLEAR";
...
export const CLOSE_IS_WAITING_MAXPARTICIPANT_VIDEO_STREAM =
  "CLOSE_IS_WAITING_MAXPARTICIPANT_VIDEO_STREAM";

// presenter Particicpant left
export const PRESENTER_LEAVE_PARTICIPANT_VIDEO =
  "PRESENTER_LEAVE_PARTICIPANT_VIDEO";

export const CLEAR_PRESENTER_PARTICIPANTS = "CLEAR_PRESENTER_PARTICIPANTS";

// state for leave Presenter View and Join one to one and other group calls
export const LEAVE_PRESENTER_JOIN_ONE_TO_OR_GROUP_CALL =
  "LEAVE_PRESENTER_JOIN_ONE_TO_OR_GROUP_CALL";

export const GETMEETINGRECORDINGFILES_INIT = "GETMEETINGRECORDINGFILES_INIT";
export const GETMEETINGRECORDINGFILES_SUCCESS =
  "GETMEETINGRECORDINGFILES_SUCCESS";
export const GETMEETINGRECORDINGFILES_FAIL = "GETMEETINGRECORDINGFILES_FAIL";

export const REQUEST_MEETING_RECORDING_TRANSCRIPT_INIT =
  "REQUEST_MEETING_RECORDING_TRANSCRIPT_INIT";
export const REQUEST_MEETING_RECORDING_TRANSCRIPT_SUCCESS =
  "REQUEST_MEETING_RECORDING_TRANSCRIPT_SUCCESS";
export const REQUEST_MEETING_RECORDING_TRANSCRIPT_FAIL =
  "REQUEST_MEETING_RECORDING_TRANSCRIPT_FAIL";
export const REQUEST_MEETING_RECORDING_TRANSCRIPT_CLEAR =
  "REQUEST_MEETING_RECORDING_TRANSCRIPT_CLEAR";

export const MEETING_TRANSCRIPT_DOWNLOADED = "MEETING_TRANSCRIPT_DOWNLOADED";

export const MEETING_MINUTES_DOWNLOADED = "MEETING_MINUTES_DOWNLOADED";
...
export const VALIDATEPASSWORD_INIT = "VALIDATEPASSWORD_INIT";
export const VALIDATEPASSWORD_SUCCESS = "VALIDATEPASSWORD_SUCCESS";
export const VALIDATEPASSWORD_FAIL = "VALIDATEPASSWORD_FAIL";

export const GET_PARTICIPANTS_OF_GROUP_CALL_INIT =
  "GET_PARTICIPANTS_OF_GROUP_CALL_INIT";
export const GET_PARTICIPANTS_OF_GROUP_CALL_SUCCESS =
  "GET_PARTICIPANTS_OF_GROUP_CALL_SUCCESS";
export const GET_PARTICIPANTS_OF_GROUP_CALL_FAIL =
  "GET_PARTICIPANTS_OF_GROUP_CALL_FAIL";
...
// For Screen Share for triggered when some share screen
export const IS_SCREEN_SHARED_TRIGGERED_INIT =
  "IS_SCREEN_SHARED_TRIGGERED_INIT";
export const IS_SCREEN_SHARED_TRIGGERED_SUCCESS =
  "IS_SCREEN_SHARED_TRIGGERED_SUCCESS";
export const IS_SCREEN_SHARED_TRIGGERED_FAIL =
  "IS_SCREEN_SHARED_TRIGGERED_FAIL";
...
//Get User Audit Listings
export const GET_USER_AUDIT_LISTING_INIT = "GET_USER_AUDIT_LISTING_INIT";
export const GET_USER_AUDIT_LISTING_SUCCESS = "GET_USER_AUDIT_LISTING_SUCCESS";
export const GET_USER_AUDIT_LISTING_FAIL = "GET_USER_AUDIT_LISTING_FAIL";

//Get User Audit Actions
export const GET_USER_AUDIT_ACTIONS_INIT = "GET_USER_AUDIT_ACTIONS_INIT";
export const GET_USER_AUDIT_ACTIONS_SUCCESS = "GET_USER_AUDIT_ACTIONS_SUCCESS";
export const GET_USER_AUDIT_ACTIONS_FAIL = "GET_USER_AUDIT_ACTIONS_FAIL";

//Save Audit logs
export const SAVE_AUDIT_LOGS_INIT = "SAVE_AUDIT_LOGS_INIT";
export const SAVE_AUDIT_LOGS_SUCCESS = "SAVE_AUDIT_LOGS_SUCCESS";
export const SAVE_AUDIT_LOGS_FAIL = "SAVE_AUDIT_LOGS_FAIL";

// save Cleint id of google and microsoft
export const SET_CLINET_ID_GOOGLE = "SET_CLINET_ID_GOOGLE";
export const SET_CLINET_ID_MS = "SET_CLINET_ID_MS";

// Audit Trial Report Download

export const EXPORT_AUDITTRIAL_REPORT_INIT = "EXPORT_AUDITTRIAL_REPORT_INIT";
export const EXPORT_AUDITTRIAL_REPORT_SUCCESS =
  "EXPORT_AUDITTRIAL_REPORT_SUCCESS";
export const EXPORT_AUDITTRIAL_REPORT_FAIL = "EXPORT_AUDITTRIAL_REPORT_FAIL";

// Count For Added as a Minutes Reviwer
export const COUNT_FOR_ADDED_AS_MINUTE_REVIWER =
  "COUNT_FOR_ADDED_AS_MINUTE_REVIWER";
// Clear the Count Added as a Minutes Reviwer
export const CLEAR_MINUTE_REVIEWER_MQTT = "CLEAR_MINUTE_REVIEWER_MQTT";
...
//Manage Authority
// export const DELETE_USER_MODAL = "DELETE_USER_MODAL";
export const DELETE_AUTHORITY_MODAL = "DELETE_AUTHORITY_MODAL";

//on click add authority Button
export const ADD_EDIT_VIEW_AUTHORITY_MODAL = "ADD_EDIT_VIEW_AUTHORITY_MODAL";

// AUTHORITY
export const GET_CLEAREMESSAGE_AUTHORITY = "GET_CLEAREMESSAGE_AUTHORITY";

export const CLEAR_COMPLIANCEDETAILS_DATA = "CLEAR_COMPLIANCEDETAILS_DATA";

export const CLEAR_COMPLIANCEDETAILS_TAB = "CLEAR_COMPLIANCEDETAILS_TAB";

// GetAllAuthority
export const GET_ALL_AUTHORITY_INIT = "GET_ALL_AUTHORITY_INIT";
export const GET_ALL_AUTHORITY_SUCCESS = "GET_ALL_AUTHORITY_SUCCESS";
export const GET_ALL_AUTHORITY_FAIL = "GET_ALL_AUTHORITY_FAIL";

// GetAuthorityByID
export const GET_AUTHORITY_BY_ID_INIT = "GET_AUTHORITY_BY_ID_INIT";
export const GET_AUTHORITY_BY_ID_SUCCESS = "GET_AUTHORITY_BY_ID_SUCCESS";
export const GET_AUTHORITY_BY_ID_FAIL = "GET_AUTHORITY_BY_ID_FAIL";

export const INITIAL_STATE_ADD_AUTHORITY = "INITIAL_STATE_ADD_AUTHORITY";
// DeleteAuthority
export const DELETE_AUTHORITY_INIT = "DELETE_AUTHORITY_INIT";
export const DELETE_AUTHORITY_SUCCESS = "DELETE_AUTHORITY_SUCCESS";
export const DELETE_AUTHORITY_FAIL = "DELETE_AUTHORITY_FAIL";

//UpdateAuthority
export const UPDATE_AUTHORITY_INIT = "UPDATE_AUTHORITY_INIT";
export const UPDATE_AUTHORITY_SUCCESS = "UPDATE_AUTHORITY_SUCCESS";
export const UPDATE_AUTHORITY_FAIL = "UPDATE_AUTHORITY_FAIL";

// AddAuthority
export const ADD_AUTHORITY_INIT = "ADD_AUTHORITY_INIT";
export const ADD_AUTHORITY_SUCCESS = "ADD_AUTHORITY_SUCCESS";
export const ADD_AUTHORITY_FAIL = "ADD_AUTHORITY_FAIL";

// IsShortCodeExists

export const IS_SHORT_CODE_EXIST_INIT = "IS_SHORT_CODE_EXIST_INIT";
export const IS_SHORT_CODE_EXIST_SUCCESS = "IS_SHORT_CODE_EXIST_SUCCESS";
export const IS_SHORT_CODE_EXIST_FAIL = "IS_SHORT_CODE_EXIST_FAIL";

// IsAuthorityNameExists
export const IS_AUTHORITY_NAME_EXIST_INIT = "IS_AUTHORITY_NAME_EXIST_INIT";
export const IS_AUTHORITY_NAME_EXIST_SUCCESS =
  "IS_AUTHORITY_NAME_EXIST_SUCCESS";
export const IS_AUTHORITY_NAME_EXIST_FAIL = "IS_AUTHORITY_NAME_EXIST_FAIL";

// ClearAuthority
export const RESOULUTION_VOTE_COUNTER = "RESOULUTION_VOTE_COUNTER";

// MQTT for authority
export const AUTHORITY_INACTIVE = "AUTHORITY_INACTIVE";
export const AUTHORITY_ACTIVE = "AUTHORITY_ACTIVE";
...
export const GET_ALL_AUTHORITIES_DROPDOWN_INIT =
  "GET_ALL_AUTHORITIES_DROPDOWN_INIT";
export const GET_ALL_AUTHORITIES_DROPDOWN_SUCCESS =
  "GET_ALL_AUTHORITIES_DROPDOWN_SUCCESS";
export const GET_ALL_AUTHORITIES_DROPDOWN_FAIL =
  "GET_ALL_AUTHORITIES_DROPDOWN_FAIL";

// GetAllTagsByOrganizationID
export const GET_ALL_TAGS_BY_ORGANIZATION_ID_INIT =
  "GET_ALL_TAGS_BY_ORGANIZATION_ID_INIT";
export const GET_ALL_TAGS_BY_ORGANIZATION_ID_SUCCESS =
  "GET_ALL_TAGS_BY_ORGANIZATION_ID_SUCCESS";
export const GET_ALL_TAGS_BY_ORGANIZATION_ID_FAIL =
  "GET_ALL_TAGS_BY_ORGANIZATION_ID_FAIL";
...
export const ADD_COMPLIANCE_CHECKLIST_INIT = "ADD_COMPLIANCE_CHECKLIST_INIT";
export const ADD_COMPLIANCE_CHECKLIST_SUCCESS =
  "ADD_COMPLIANCE_CHECKLIST_SUCCESS";
export const ADD_COMPLIANCE_CHECKLIST_FAIL = "ADD_COMPLIANCE_CHECKLIST_FAIL";

// /GetComplianceChecklistsByComplianceId
export const GET_COMPLIANCE_CHECKLIST_BY_COMPLIANCE_ID_INIT =
  "GET_COMPLIANCE_CHECKLIST_BY_COMPLIANCE_ID_INIT";
export const GET_COMPLIANCE_CHECKLIST_BY_COMPLIANCE_ID_SUCCESS =
  "GET_COMPLIANCE_CHECKLIST_BY_COMPLIANCE_ID_SUCCESS";
export const GET_COMPLIANCE_CHECKLIST_BY_COMPLIANCE_ID_FAIL =
  "GET_COMPLIANCE_CHECKLIST_BY_COMPLIANCE_ID_FAIL";

// CheckComplianceTitleExists
export const CHECK_COMPLIANCE_TITLE_EXIST_INIT =
  "CHECK_COMPLIANCE_TITLE_EXIST_INIT";
export const CHECK_COMPLIANCE_TITLE_EXIST_SUCCESS =
  "CHECK_COMPLIANCE_TITLE_EXIST_SUCCESS";
export const CHECK_COMPLIANCE_TITLE_EXIST_FAIL =
  "CHECK_COMPLIANCE_TITLE_EXIST_FAIL";

// ViewComplianceById
export const VIEW_COMPLIANCE_BY_ID_INIT = "VIEW_COMPLIANCE_BY_ID_INIT";
export const VIEW_COMPLIANCE_BY_ID_SUCCESS = "VIEW_COMPLIANCE_BY_ID_SUCCESS";
export const VIEW_COMPLIANCE_BY_ID_FAIL = "VIEW_COMPLIANCE_BY_ID_FAIL";

// CheckChecklistTitleExists
// export const CheckChecklistTitleExists
export const CHECK_CHECKLIST_TITLE_EXISTS_INIT =
  "CHECK_CHECKLIST_TITLE_EXISTS_INIT";
export const CHECK_CHECKLIST_TITLE_EXISTS_SUCCESS =
  "CHECK_CHECKLIST_TITLE_EXISTS_SUCCESS";
export const CHECK_CHECKLIST_TITLE_EXISTS_FAIL =
  "CHECK_CHECKLIST_TITLE_EXISTS_FAIL";

export const GET_CLEAREMESSAGE_COMPLIANCE = "GET_CLEAREMESSAGE_COMPLIANCE";
//

// AddTaskMappingToChecklist
export const ADD_TASK_MAPPIING_TO_CHECKLIST_INIT =
  "ADD_TASK_MAPPIING_TO_CHECKLIST_INIT";
export const ADD_TASK_MAPPIING_TO_CHECKLIST_SUCCESS =
  "ADD_TASK_MAPPIING_TO_CHECKLIST_SUCCESS";
export const ADD_TASK_MAPPIING_TO_CHECKLIST_FAIL =
  "ADD_TASK_MAPPIING_TO_CHECKLIST_FAIL";

// GetComplianceChecklistsWithTasksByComplianceId
export const GET_TASK_BY_COMPLIANCE_ID_INIT = "GET_TASK_BY_COMPLIANCE_ID_INIT";
export const GET_TASK_BY_COMPLIANCE_ID_SUCCESS =
  "GET_TASK_BY_COMPLIANCE_ID_SUCCESS";
export const GET_TASK_BY_COMPLIANCE_ID_FAIL = "GET_TASK_BY_COMPLIANCE_ID_FAIL";

// EditComplianceChecklist
export const EDIT_COMPLIANCE_CHECKLIST_INIT = "EDIT_COMPLIANCE_CHECKLIST_INIT";
export const EDIT_COMPLIANCE_CHECKLIST_SUCCESS =
  "EDIT_COMPLIANCE_CHECKLIST_SUCCESS";
export const EDIT_COMPLIANCE_CHECKLIST_FAIL = "EDIT_COMPLIANCE_CHECKLIST_FAIL";

export const LIST_OF_COMPLIANCE_BY_CREATOR_INIT =
  "LIST_OF_COMPLIANCE_BY_CREATOR_INIT";
export const LIST_OF_COMPLIANCE_BY_CREATOR_SUCCESS =
  "LIST_OF_COMPLIANCE_BY_CREATOR_SUCCESS";
export const LIST_OF_COMPLIANCE_BY_CREATOR_FAIL =
  "LIST_OF_COMPLIANCE_BY_CREATOR_FAIL";

export const VIEW_COMPLIANCE_BY_ME_DETAILS_INIT =
  "VIEW_COMPLIANCE_BY_ME_DETAILS_INIT";
export const VIEW_COMPLIANCE_BY_ME_DETAILS_SUCCESS =
  "VIEW_COMPLIANCE_BY_ME_DETAILS_SUCCESS";
export const VIEW_COMPLIANCE_BY_ME_DETAILS_FAIL =
  "VIEW_COMPLIANCE_BY_ME_DETAILS_FAIL";

export const VIEW_COMPLIANCE_FOR_ME_BY_ID_INIT =
  "VIEW_COMPLIANCE_FOR_ME_BY_ID_INIT";
export const VIEW_COMPLIANCE_FOR_ME_BY_ID_SUCCESS =
  "VIEW_COMPLIANCE_FOR_ME_BY_ID_SUCCESS";
export const VIEW_COMPLIANCE_FOR_ME_BY_ID_FAIL =
  "VIEW_COMPLIANCE_FOR_ME_BY_ID_FAIL";

export const SEARCH_COMPLIANCE_FOR_ME_INIT = "SEARCH_COMPLIANCE_FOR_ME_INIT";
export const SEARCH_COMPLIANCE_FOR_ME_SUCCESS =
  "SEARCH_COMPLIANCE_FOR_ME_SUCCESS";
export const SEARCH_COMPLIANCE_FOR_ME_FAIL = "SEARCH_COMPLIANCE_FOR_ME_FAIL";

export const GET_COMPLIANCE_TASK_BY_COMPLIANCE_ID_FOR_ME_INIT =
  "GET_COMPLIANCE_TASK_BY_COMPLIANCE_ID_FOR_ME_INIT";
export const GET_COMPLIANCE_TASK_BY_COMPLIANCE_ID_FOR_ME_SUCCESS =
  "GET_COMPLIANCE_TASK_BY_COMPLIANCE_ID_FOR_ME_SUCCESS";
export const GET_COMPLIANCE_TASK_BY_COMPLIANCE_ID_FOR_ME_FAIL =
  "GET_COMPLIANCE_TASK_BY_COMPLIANCE_ID_FOR_ME_FAIL";

export const GET_COMPLIACE_STATUS_INIT = "GET_COMPLIACE_STATUS_INIT";
export const GET_COMPLIACE_STATUS_SUCCESS = "GET_COMPLIACE_STATUS_SUCCESS";
export const GET_COMPLIACE_STATUS_FAIL = "GET_COMPLIACE_STATUS_FAIL";

export const CURRENT_MEETING_INFO = "CURRENT_MEETING_INFO";
export const CLEAR_CURRENT_MEETING_INFO = "CLEAR_CURRENT_MEETING_INFO";
export const GET_QUARTERLY_SUBMITTED_COMPLIANCES_INIT =
  "GET_QUARTERLY_SUBMITTED_COMPLIANCES_INIT";
export const GET_QUARTERLY_SUBMITTED_COMPLIANCES_SUCCESS =
  "GET_QUARTERLY_SUBMITTED_COMPLIANCES_SUCCESS";
export const GET_QUARTERLY_SUBMITTED_COMPLIANCES_FAIL =
  "GET_QUARTERLY_SUBMITTED_COMPLIANCES_FAIL";

export const GET_UPCOMING_COMPLIANCES_DEADLINE_INIT =
  "GET_UPCOMING_COMPLIANCES_DEADLINE_INIT";
export const GET_UPCOMING_COMPLIANCES_DEADLINE_SUCCESS =
  "GET_UPCOMING_COMPLIANCES_DEADLINE_SUCCESS";
export const GET_UPCOMING_COMPLIANCES_DEADLINE_FAIL =
  "GET_UPCOMING_COMPLIANCES_DEADLINE_FAIL";

export const GET_COMPLIANCE_BY_DASHBOARD_INIT =
  "GET_COMPLIANCE_BY_DASHBOARD_INIT";
export const GET_COMPLIANCE_BY_DASHBOARD_SUCCESS =
  "GET_COMPLIANCE_BY_DASHBOARD_SUCCESS";
export const GET_COMPLIANCE_BY_DASHBOARD_FAIL =
  "GET_COMPLIANCE_BY_DASHBOARD_FAIL";

export const GET_COMPLIANCE_TASKS_DASHBOARD_INIT =
  "GET_COMPLIANCE_TASKS_DASHBOARD_INIT";
export const GET_COMPLIANCE_TASKS_DASHBOARD_SUCCESS =
  "GET_COMPLIANCE_TASKS_DASHBOARD_SUCCESS";
export const GET_COMPLIANCE_TASKS_DASHBOARD_FAIL =
  "GET_COMPLIANCE_TASKS_DASHBOARD_FAIL";

export const GET_COMPLIANCE_REOPEN_DASHBOARD_INIT =
  "GET_COMPLIANCE_REOPEN_DASHBOARD_INIT";
export const GET_COMPLIANCE_REOPEN_DASHBOARD_SUCCESS =
  "GET_COMPLIANCE_REOPEN_DASHBOARD_SUCCESS";
export const GET_COMPLIANCE_REOPEN_DASHBOARD_FAIL =
  "GET_COMPLIANCE_REOPEN_DASHBOARD_FAIL";

export const GET_COMPLIANCE_QUARTERLY_TASK_DASHBOARD_INIT =
  "GET_COMPLIANCE_QUARTERLY_TASK_DASHBOARD_INIT";
export const GET_COMPLIANCE_QUARTERLY_TASK_DASHBOARD_SUCCESS =
  "GET_COMPLIANCE_QUARTERLY_TASK_DASHBOARD_SUCCESS";
export const GET_COMPLIANCE_QUARTERLY_TASK_DASHBOARD_FAIL =
  "GET_COMPLIANCE_QUARTERLY_TASK_DASHBOARD_FAIL";

export const EDIT_COMPLIANCE_INIT = "EDIT_COMPLIANCE_INIT";
export const EDIT_COMPLIANCE_SUCCESS = "EDIT_COMPLIANCE_SUCCESS";
export const EDIT_COMPLIANCE_FAIL = "EDIT_COMPLIANCE_FAIL";

//API For Report Compliance Listing
export const COMPLIANCE_REPORT_LISTING_INIT = "COMPLIANCE_REPORT_LISTING_INIT";
export const COMPLIANCE_REPORT_LISTING_SUCCESS =
  "COMPLIANCE_REPORT_LISTING_SUCCESS";
export const COMPLIANCE_REPORT_LISTING_FAIL = "COMPLIANCE_REPORT_LISTING_FAIL";
// Reopen Complaince Step 1
// Add Reopen Compliance
export const ADD_REOPEN_COMPLIANCE_INIT = "ADD_REOPEN_COMPLIANCE_INIT";
export const ADD_REOPEN_COMPLIANCE_SUCCESS = "ADD_REOPEN_COMPLIANCE_SUCCESS";
export const ADD_REOPEN_COMPLIANCE_FAIL = "ADD_REOPEN_COMPLIANCE_FAIL";

// Reopen Complaince Step 2
// CreateComplianceDataRoomMap
export const CREATE_COMPLIANCE_DATA_ROOM_MAP_INIT =
  "CREATE_COMPLIANCE_DATA_ROOM_MAP_INIT";
export const CREATE_COMPLIANCE_DATA_ROOM_MAP_SUCCESS =
  "CREATE_COMPLIANCE_DATA_ROOM_MAP_SUCCESS";
export const CREATE_COMPLIANCE_DATA_ROOM_MAP_FAIL =
  "CREATE_COMPLIANCE_DATA_ROOM_MAP_FAIL";
...
// SaveComplianceFiles
export const SAVE_COMPLIANCE_FILES_INIT = "SAVE_COMPLIANCE_FILES_INIT";
export const SAVE_COMPLIANCE_FILES_SUCCESS = "SAVE_COMPLIANCE_FILES_SUCCESS";
export const SAVE_COMPLIANCE_FILES_FAIL = "SAVE_COMPLIANCE_FILES_FAIL";

// Reopen Complaince Step 5 (After this Edit api will be hit in edit flow)
// SaveComplianceDocumentsAndMapping
export const SAVE_COMPLIANCE_DOCUMENTS_AND_MAPPING_INIT =
  "SAVE_COMPLIANCE_DOCUMENTS_AND_MAPPING_INIT";
export const SAVE_COMPLIANCE_DOCUMENTS_AND_MAPPING_SUCCESS =
  "SAVE_COMPLIANCE_DOCUMENTS_AND_MAPPING_SUCCESS";
export const SAVE_COMPLIANCE_DOCUMENTS_AND_MAPPING_FAIL =
  "SAVE_COMPLIANCE_DOCUMENTS_AND_MAPPING_FAIL";
...
// ChangeTaskStatus
export const CHANGE_TASK_STATUS_INIT = "CHANGE_TASK_STATUS_INIT";
...
export const CREATE_COMPLAINCE_DATAROOM_MAP = "CREATE_COMPLAINCE_DATAROOM_MAP";

export const TASK_REDUCER_LOADER = "TASK_REDUCER_LOADER";

//API For Get End Of Compliance Report
export const Get_END_OF_COMPLIANCE_REPORT_INIT =
  "Get_END_OF_COMPLIANCE_REPORT_INIT";
export const Get_END_OF_COMPLIANCE_REPORT_SUCCESS =
  "Get_END_OF_COMPLIANCE_REPORT_SUCCESS";
export const Get_END_OF_COMPLIANCE_REPORT_FAIL =
  "Get_END_OF_COMPLIANCE_REPORT_FAIL";

//API For Get Quarter Report
export const Get_QUARTER_REPORT_INIT = "Get_QUARTER_REPORT_INIT";
export const Get_QUARTER_REPORT_SUCCESS = "Get_QUARTER_REPORT_SUCCESS";
export const Get_QUARTER_REPORT_FAIL = "Get_QUARTER_REPORT_FAIL";

//API For Get Compliance Standing Report
export const Get_COMPLIANCE_STANDING_REPORT_INIT =
  "Get_COMPLIANCE_STANDING_REPORT_INIT";
export const Get_COMPLIANCE_STANDING_REPORT_SUCCESS =
  "Get_COMPLIANCE_STANDING_REPORT_SUCCESS";
export const Get_COMPLIANCE_STANDING_REPORT_FAIL =
  "Get_COMPLIANCE_STANDING_REPORT_FAIL";

//API For Get Accumulative Report
export const Get_ACCUMULATIVE_REPORT_INIT = "Get_ACCUMULATIVE_REPORT_INIT";
export const Get_ACCUMULATIVE_REPORT_SUCCESS =
  "Get_ACCUMULATIVE_REPORT_SUCCESS";
export const Get_ACCUMULATIVE_REPORT_FAIL = "Get_ACCUMULATIVE_REPORT_FAIL";
export const COMPLIANCE_CREATED_MQTT = "COMPLIANCE_CREATED_MQTT";

export const COMPLIANCE_CHECKLIST_ADDED_MQTT =
  "COMPLIANCE_CHECKLIST_ADDED_MQTT";

export const COMPLIANCE_CHECKLIST_UPDATED_MQTT =
  "COMPLIANCE_CHECKLIST_UPDATED_MQTT";

export const COMPLIANCE_CHECKLIST_DELETED_MQTT =
  "COMPLIANCE_CHECKLIST_DELETED_MQTT";

export const COMPLIANCE_UPDATED_MQTT = "COMPLIANCE_UPDATED_MQTT";

export const COMPLIANCE_REOPEN_MQTT = "COMPLIANCE_REOPEN_MQTT";

export const TASK_MAPPED_WITH_CHECKLIST_MQTT =
  "TASK_MAPPED_WITH_CHECKLIST_MQTT";

export const ACTIVE_CREATE_AND_EDIT_MEETING_TAB =
  "ACTIVE_CREATE_AND_EDIT_MEETING_TAB";

export const ACTIVE_VIEW_MEETING_TAB = "ACTIVE_VIEW_MEETING_TAB";

export const MEETING_STATUS_UPDATE_INIT = "MEETING_STATUS_UPDATE_INIT";
export const MEETING_STATUS_UPDATE_SUCCESS = "MEETING_STATUS_UPDATE_SUCCESS";
export const MEETING_STATUS_UPDATE_FAIL = "MEETING_STATUS_UPDATE_FAIL";

export const VIEW_ADVANCE_MEETING_MODAL = "VIEW_ADVANCE_MEETING_MODAL";

export const VIEW_ADVANCE_MEETING_DETAILS_TAB =
  "VIEW_ADVANCE_MEETING_DETAILS_TAB";
export const VIEW_ADVANCE_MEETING_ORGANIZER_TAB =
  "VIEW_ADVANCE_MEETING_ORGANIZER_TAB";
export const VIEW_ADVANCE_MEETING_AGENDACONTRIBUTOR_TAB =
  "VIEW_ADVANCE_MEETING_AGENDACONTRIBUTOR_TAB";
export const VIEW_ADVANCE_MEETING_PARTICIPANTS_TAB =
  "VIEW_ADVANCE_MEETING_PARTICIPANTS_TAB";
export const VIEW_ADVANCE_MEETING_AGENDABUILDER_TAB =
  "VIEW_ADVANCE_MEETING_AGENDABUILDER_TAB";
export const VIEW_ADVANCE_MEETING_AGENDAVIEWER_TAB =
  "VIEW_ADVANCE_MEETING_AGENDAVIEWER_TAB";
export const VIEW_ADVANCE_MEETING_MINUTES_TAB =
  "VIEW_ADVANCE_MEETING_MINUTES_TAB";
export const VIEW_ADVANCE_MEETING_TASK_TAB = "VIEW_ADVANCE_MEETING_TASK_TAB";
export const VIEW_ADVANCE_MEETING_POLLS_TAB = "VIEW_ADVANCE_MEETING_POLLS_TAB";
export const VIEW_ADVANCE_MEETING_ATTENDANCE_TAB =
  "VIEW_ADVANCE_MEETING_ATTENDANCE_TAB";
export const VIEW_ADVANCE_MEETING_ATTENDEES_TAB =
  "VIEW_ADVANCE_MEETING_ATTENDEES_TAB";
export const VIEW_ADVANCE_MEETING_RECORDING_TAB =
  "VIEW_ADVANCE_MEETING_RECORDING_TAB";

export const UPCOMING_DEADLINE_DASHBOARD_MANAGER_MQTT =
  "UPCOMING_DEADLINE_DASHBOARD_MANAGER_MQTT";

export const UPCOMING_COMPLIANCE_DEADLINE_USER_MQTT =
  "UPCOMING_COMPLIANCE_DEADLINE_USER_MQTT";

export const QUARTERLY_TASK_DASHBOARD_FOR_USER_MQTT =
  "QUARTERLY_TASK_DASHBOARD_FOR_USER_MQTT";

export const QUARTERLY_TASK_DASHBOARD_FOR_MANAGER_MQTT =
  "QUARTERLY_TASK_DASHBOARD_FOR_MANAGER_MQTT";

export const TASK_DASHBOARD_FOR_USER_MQTT = "TASK_DASHBOARD_FOR_USER_MQTT";
export const TASK_DASHBOARD_FOR_MANAGER_MQTT =
  "TASK_DASHBOARD_FOR_MANAGER_MQTT";

export const COMPLIANCE_BY_DASHBOARD_USER_MQTT =
  "COMPLIANCE_BY_DASHBOARD_USER_MQTT";
export const COMPLIANCE_BY_DASHBOARD_MANAGER_MQTT =
  "COMPLIANCE_BY_DASHBOARD_MANAGER_MQTT";

export const QUARTERLY_SUBMITTED_DASHBOARD_USER_MQTT =
  "QUARTERLY_SUBMITTED_DASHBOARD_USER_MQTT";
export const QUARTERLY_SUBMITTED_DASHBOARD_MANAGER_MQTT =
  "QUARTERLY_SUBMITTED_DASHBOARD_MANAGER_MQTT";

export const REOPEN_COMPLIANCE_DASHBOARD_USER_MQTT =
  "REOPEN_COMPLIANCE_DASHBOARD_USER_MQTT";
export const REOPEN_COMPLIANCE_DASHBOARD_MANAGER_MQTT =
  "REOPEN_COMPLIANCE_DASHBOARD_MANAGER_MQTT";

export const GET_ALL_COMPLIANCE_AUTHORITIES_INIT =
  "GET_ALL_COMPLIANCE_AUTHORITIES_INIT";
export const GET_ALL_COMPLIANCE_AUTHORITIES_SUCCESS =
  "GET_ALL_COMPLIANCE_AUTHORITIES_SUCCESS";
export const GET_ALL_COMPLIANCE_AUTHORITIES_FAIL =
  "GET_ALL_COMPLIANCE_AUTHORITIES_FAIL";

export const CHANGE_CHECKLIST_STATUS_INIT = "CHANGE_CHECKLIST_STATUS_INIT";
export const CHANGE_CHECKLIST_STATUS_SUCCESS =
  "CHANGE_CHECKLIST_STATUS_SUCCESS";
export const CHANGE_CHECKLIST_STATUS_FAIL = "CHANGE_CHECKLIST_STATUS_FAIL";

export const TASK_STATUS_CHANGED_FOR_USER_MQTT =
  "TASK_STATUS_CHANGED_FOR_USER_MQTT";

// ─── Modal Toggles ───────────────────────────────────────────────────────────
export const TOGGLE_CREATE_EDIT_MEETING_MODAL =
  "TOGGLE_CREATE_EDIT_MEETING_MODAL";
export const TOGGLE_CREATE_EDIT_QUICK_MEETING_MODAL =
  "TOGGLE_CREATE_EDIT_QUICK_MEETING_MODAL";
export const TOGGLE_CREATE_EDIT_PROPOSED_MEETING_MODAL =
  "TOGGLE_CREATE_EDIT_PROPOSED_MEETING_MODAL";
export const TOGGLE_VIEW_MEETING_MODAL = "TOGGLE_VIEW_MEETING_MODAL";
export const TOGGLE_VIEW_QUICK_MEETING_MODAL =
  "TOGGLE_VIEW_QUICK_MEETING_MODAL";
export const TOGGLE_VIEW_PROPOSED_MEETING_MODAL =
  "TOGGLE_VIEW_PROPOSED_MEETING_MODAL";
export const SET_ADVANCE_MEETING_ROUTE = "SET_ADVANCE_MEETING_ROUTE";
export const TOGGLE_UNSAVED_CHANGES_MODAL = "TOGGLE_UNSAVED_CHANGES_MODAL";
export const TOGGLE_LEAVE_MEETING_MODAL = "TOGGLE_LEAVE_MEETING_MODAL";
export const TOGGLE_END_MEETING_MODAL = "TOGGLE_END_MEETING_MODAL";

// ─── Create & Edit Meeting Tabs ───────────────────────────────────────────────
export const SET_CREATE_EDIT_TAB = "SET_CREATE_EDIT_TAB";
export const RESET_CREATE_EDIT_TABS = "RESET_CREATE_EDIT_TABS";

// ─── View Meeting Tabs ────────────────────────────────────────────────────────
export const SET_VIEW_TAB = "SET_VIEW_TAB";
export const RESET_VIEW_TABS = "RESET_VIEW_TABS";

export const VIEW_COMMITTEE_DETAILS = "VIEW_COMMITTEE_DETAILS";
export const VIEW_GROUP_DETAILS = "VIEW_GROUP_DETAILS";
export const RESET_VIEW_COMMITTEE_DETAILS = "RESET_VIEW_COMMITTEE_DETAILS";
export const RESET_VIEW_GROUP_DETAILS = "RESET_VIEW_GROUP_DETAILS";

export const SET_PROPOSED_MEETING_ROUTE = "SET_PROPOSED_MEETING_ROUTE";

export const PARTICIPANT_RESPOND_PROPOSED_MEETING_DATES =
  "PARTICIPANT_RESPOND_PROPOSED_MEETING_DATES";
export const ORGANIZER_RESPONSE_PROPOSED_MEETING_DATES =
  "ORGANIZER_RESPONSE_PROPOSED_MEETING_DATES";
export const SIGNATURE_SIGNEE_CREATOR_COUNT_UPDATE =
  "SIGNATURE_SIGNEE_CREATOR_COUNT_UPDATE";

export const NOTIFY_PARTICIPANTS_WHEN_HOST_IS_TRANSFERRED =
  "NOTIFY_PARTICIPANTS_WHEN_HOST_IS_TRANSFERRED";

export const GROUP_PROPOSED_MEETING = "GROUP_PROPOSED_MEETING";
export const COMMITTEE_PROPOSED_MEETING = "COMMITTEE_PROPOSED_MEETING";
export const GET_VIDEOCALL_PRESENTATION_PARTICIPANTS_INIT =
  "GET_VIDEOCALL_PRESENTATION_PARTICIPANTS_INIT";
export const GET_VIDEOCALL_PRESENTATION_PARTICIPANTS_SUCCESS =
  "GET_VIDEOCALL_PRESENTATION_PARTICIPANTS_SUCCESS";
export const GET_VIDEOCALL_PRESENTATION_PARTICIPANTS_FAIL =
  "GET_VIDEOCALL_PRESENTATION_PARTICIPANTS_FAIL";

// Real-time (MQTT-driven) incremental updates to presentationParticipantsList
export const PRESENTATION_PARTICIPANT_JOINED_MQTT =
  "PRESENTATION_PARTICIPANT_JOINED_MQTT";
export const PRESENTATION_PARTICIPANT_LEFT_MQTT =
  "PRESENTATION_PARTICIPANT_LEFT_MQTT";

export const MEETING_PROPOSED_FOR_ORGANIZER = "MEETING_PROPOSED_FOR_ORGANIZER";
export const MEETING_PROPOSED_FOR_PARTICIPANT =
  "MEETING_PROPOSED_FOR_PARTICIPANT";
export const MEETING_VIEW_DETAILS = "MEETING_VIEW_DETAILS";

export const DELETE_MEETING_MQTT = "DELETE_MEETING_MQTT";

export const GROUP_VIDEOCALL_STATUS_REJOIN_CALL_INIT = "GROUP_VIDEOCALL_STATUS_REJOIN_CALL_INIT";
export const GROUP_VIDEOCALL_STATUS_REJOIN_CALL_SUCCESS = "GROUP_VIDEOCALL_STATUS_REJOIN_CALL_SUCCESS";
export const GROUP_VIDEOCALL_STATUS_REJOIN_CALL_FAIL = "GROUP_VIDEOCALL_STATUS_REJOIN_CALL_FAIL";

// CR(0012249) — Presentation waiting-room MQTT signals. Each just captures
// the latest raw MQTT payload into Redux (mirrors presentationParticipantJoinedMqtt's
// {type, response} shape) — no side effects on existing meeting-video state.
export const PRESENTATION_PARTICIPANT_JOIN_REQUESTS_MQTT =
  "PRESENTATION_PARTICIPANT_JOIN_REQUESTS_MQTT";
export const PRESENTATION_JOIN_REQUEST_APPROVED_MQTT =
  "PRESENTATION_JOIN_REQUEST_APPROVED_MQTT";
export const PRESENTATION_JOIN_REQUEST_REJECTED_MQTT =
  "PRESENTATION_JOIN_REQUEST_REJECTED_MQTT";
export const PRESENTATION_NEW_PARTICIPANTS_JOINED_MQTT =
  "PRESENTATION_NEW_PARTICIPANTS_JOINED_MQTT";
export const REMOVED_FROM_PRESENTATION_TO_WAITING_ROOM_MQTT =
  "REMOVED_FROM_PRESENTATION_TO_WAITING_ROOM_MQTT";
export const PARTICIPANT_REMOVED_FROM_PRESENTATION_MQTT =
  "PARTICIPANT_REMOVED_FROM_PRESENTATION_MQTT";
export const MEETING_PRESENTATION_STOPPED_MQTT =
  "MEETING_PRESENTATION_STOPPED_MQTT";
// Local optimistic removal from presentationWaitingParticipantsList when
// the host clicks Admit/Deny — mirrors ACCEPT_AND_REMOVE_PARTICIPANTS but
// targets the presentation waiting list instead of waitingParticipantsList.
export const PRESENTATION_ACCEPT_AND_REMOVE_PARTICIPANTS =
  "PRESENTATION_ACCEPT_AND_REMOVE_PARTICIPANTS";