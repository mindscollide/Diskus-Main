...
// Global state for start Presenter
export const START_PRESENTER_GLOBAL_STATE = "START_PRESENTER_GLOBAL_STATE";

// Global state for stop Presenter
export const STOP_PRESENTER_GLOBAL_STATE = "STOP_PRESENTER_GLOBAL_STATE";
...
//Presenter Slow Internet Connectivity
export const PRESENTER_SLOW_INTERNET_CONNECTIVITY =
  "PRESENTER_SLOW_INTERNET_CONNECTIVITY";
