...
import { CustomMiscellaneous, CustomSetting, Dashboard, Home, Login, Meeting, NotFound, OnBoard, SignUp, TodoList, VerificationSignUp } from '../container';
import AddUser from '../container/Admin/AllUsers/AddUser/AddUser';
import EditUser from '../container/Admin/AllUsers/AllUserPage/AllUserPage';
...
export const router = createBrowserRouter(
    createRoutesFromElements(
        <>
            ...
            <Route path="/updatePasswordSuccess" element={<PasswordUpdateMessage />} />
            ...
            <Route element={< PrivateAdminRoute />}>
                <Route exact path="/Diskus/Admin/" element={<AdminHome />}>
                    ...
                    <Route path="AllUserPage" element={<EditUser />} />
