    ...
    return (
        <div className="talk_nav">
            <div className={subIcons ? "border w-100 rounded" : "border-0"}>
                ...
                <div className={subIcons ? "talk_subIcon" : "talk_subIcon_hidden"}>
                    <svg id="Icon_feather-video" data-name="Icon feather-video" xmlns="http://www.w3.org/2000/svg" width="34" height="29.4" viewBox="0 0 44.65 29.4">
                        <defs>
                            <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                                <stop offset="0" stop-color="#4adede" />
                                <stop offset="1" stop-color="#6172d6" />
                ...
                <div className={subIcons ? "talk_subIcon" : "talk_subIcon_hidden"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="36.444" viewBox="0 0 45.792 36.444">
                        <defs>
                            <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                                <stop offset="0" stop-color="#4adede" />
                                <stop offset="1" stop-color="#6172d6" />
