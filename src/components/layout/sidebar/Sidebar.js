...
const Sidebar = () => {
  ...
  const advanceMeetingCreateEditModal = useSelector(
    (state) => state.ModalStatesReducer.isCreateEditMeetingModal,
  );
  const proposedMeetingCreateEditModal = useSelector(
    (state) => state.ModalStatesReducer.isCreateEditProposedMeetingModal,
  );
  const advanceMeetingViewModal = useSelector(
    (state) => state.ModalStatesReducer.isViewMeetingModal,
  );

  const proposedMeetingViewModal = useSelector(
  ...
  //     advanceMeetingViewModal ||
  //     proposedMeetingCreateEditModal ||
  //     proposedMeetingViewModal;
  ...
  const handleSidebarNavigation = ({
    ...
    if (location.pathname !== targetPath) {
      ...
      if (advanceMeetingViewModal) {
        console.log("createEditComplaince", targetPath);
              ...
              <>
                ...
                {checkFeatureIDAvailability(77) ? (
                  <Nav.Link
                    ...
                    draggable='false'
                    className={
                      location.pathname === "/Diskus/compliance" ||
                      location.pathname === "/Diskus/compliance"
                        ? "m-0 p-0 iconItem_activeSideBarMain"
                        : "m-0 p-0 iconItemSideBarMain"
                    }
                    ...
                    {/* Resolution Icon */}
                    <div
                      className={`complianceIcon d-flex flex-column justify-content-center align-items-center ${
                        location.pathname === "/Diskus/compliance"
                          ? "active"
                          : ""
                      }`}
                      ...
                      <svg
                        ...
                        fill='none'>
                        <path
                          d='M27.1562 5.80469L26.4492 15.5635C25.8859 23.3174 21.0491 30.0825 13.96 33.0117L13.5781 33.1699L13.1963 33.0117C6.1069 30.0824 1.27029 23.3094 0.707031 15.5645L0 5.80469L13.5781 0L27.1562 5.80469ZM2.09668 7.08203L2.70117 15.4189C3.20024 22.2829 7.41052 28.2796 13.5781 30.9971C19.746 28.2798 23.956 22.2911 24.4551 15.4189L25.0586 7.08203L13.5781 2.17578L2.09668 7.08203ZM19.291 11.3936C19.6782 10.9999 20.3113 10.9947 20.7051 11.3818C21.0986 11.769 21.1038 12.4021 20.7168 12.7959L11.8818 21.7832C11.6939 21.9742 11.4369 22.0819 11.1689 22.082C10.9008 22.082 10.643 21.9735 10.4551 21.7822L6.4375 17.6924L6.37012 17.6152C6.05349 17.2198 6.08126 16.6411 6.4502 16.2783C6.81959 15.9157 7.39924 15.8979 7.78906 16.2217L7.86523 16.291L11.1689 19.6543L19.291 11.3936Z'
                          fill='url(#paint0_linear_980_155709)'
                        />
                        <defs>
                          <linearGradient
                            id='paint0_linear_980_155709'
                            x1='-1.01611'
                            y1='18.5879'
                            x2='27.4839'
                            y2='18.0879'
                      ...
                      <span draggable='false'>{t("Compliance")}</span>
                    </div>
                  </Nav.Link>
                ) : null}
