...
const Sidebar = () => {
  ...
  return (
    <>
      {location.pathname.includes("/DisKus/Admin") ? "" : <Row className="sidebar-row">
        <Col
          sm={2}
          className={
        ...
        >
          <Nav className="new_sidebar p-0 d-flex justify-content-center gap-5 align-items-center flex-column">
            ...
            <>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="39.078" viewBox="0 0 51.227 39.078">
                  <defs>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="46.081" viewBox="0 0 48.346 46.081">
                  <defs>
                    <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                      <stop offset="0" stop-color="#4adede" />
                      <stop offset="1" stop-color="#6172d6" />
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="44.281" viewBox="0 0 44.281 44.281">
                  <defs>
                    <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                      <stop offset="0" stop-color="#4adede" />
                      <stop offset="1" stop-color="#6172d6" />
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="48.231" viewBox="0 0 49.694 48.231">
                  <defs>
                    <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                      <stop offset="0" stop-color="#4adede" />
                      <stop offset="1" stop-color="#6172d6" />
